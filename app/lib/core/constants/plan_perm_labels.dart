...
const Map<String, String> kPermissionLabelsAr = {
  ...
  'accounts.read': 'الحسابات (صندوق — استلام وصرف وتشغيل)',
  'finance.sensitive.read': 'البيانات المالية الحساسة (أتعاب العملاء، ملخصات، أرباح المكتب)',
  'finance.audit.read': 'سجل التدقيق المالي',
